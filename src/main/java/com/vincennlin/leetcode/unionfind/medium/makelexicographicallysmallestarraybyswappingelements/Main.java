...
public class Main {
    public static void main(String[] args) {
        ...
        int[] result1 = solution.lexicographicallySmallestArray(new int[] {1, 5, 3, 9, 8}, 2);
        System.out.println(Arrays.toString(result1)); // [1,3,5,8,9]

        int[] result2 = solution.lexicographicallySmallestArray(new int[] {1, 7, 6, 18, 2, 1}, 3);
        System.out.println(Arrays.toString(result2)); // [1,6,7,18,1,2]

        int[] result3 = solution.lexicographicallySmallestArray(new int[] {1, 7, 28, 19, 10}, 3);
