...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Solution.TreeNode root2 = new Solution.TreeNode(3);
        root2.left = new Solution.TreeNode(9);
        root2.right = new Solution.TreeNode(20);
        root2.right.left = new Solution.TreeNode(15);
        root2.right.right = new Solution.TreeNode(7);
