...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(customStack.pop());                            // return 202 --> Return top of the stack 202, stack becomes [201]

        System.out.println(customStack.pop());                            // return 201 --> Return top of the stack 201, stack becomes []
