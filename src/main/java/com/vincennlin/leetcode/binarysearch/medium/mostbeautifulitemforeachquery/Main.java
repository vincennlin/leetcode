...
public class Main {
    public static void main(String[] args) {
        ...
        int[][] items1 = new int[][]{{1, 2}, {3, 2}, {2, 4}, {5, 6}, {3, 5}};
        int[] queries1 = new int[]{1, 2, 3, 4, 5, 6};

        int[] result1 = solution.maximumBeauty(items1, queries1);
        System.out.println(Arrays.toString(result1)); // [2, 4, 5, 5, 6, 6]

        int[][] items2 = new int[][]{{1, 2}, {1, 2}, {1, 3}, {1, 4}};
        int[] queries2 = new int[]{1};

        int[] result2 = solution.maximumBeauty(items2, queries2);
        System.out.println(Arrays.toString(result2)); // [4]

        int[][] items3 = new int[][]{{10, 1000}};
        int[] queries3 = new int[]{5};
